...
@Controller
@RequestMapping("/scp")
public final class SCPValidateCodeController extends MTBaseController {
    ...
    public void getValidateCode(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            BufferedImage bufferedImage = vc.getspcImage();
            request.getSession().setAttribute("yzcode", vc.getspcText());
