...
<script>
    ...
    function paySms() {
        ...
        // todo
        if (payment == 'wxpay') {
            window.location.href = ' ${zl.web.dcms.domain}/pays-web/web/wxpay/scanPay2Self.action?shopcode=' + shopcode + '&billcode=' + billcode + '&payamount=' + payamount + '&businessorigin=' + payflag;
        } else {
            window.location.href = ' ${zl.web.dcms.domain}/pays-web/web/alipay/scanPay2Self.action?shopcode=' + shopcode + '&billcode=' + billcode + '&payamount=' + payamount + '&businessorigin=' + payflag;
        }
    }
