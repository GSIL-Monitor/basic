...
<style type="text/css">
    ...
    .paysuccess-block-icon i{
        ...
        display: block;
        margin: auto;
        background-image: url(${zl.web.resource.address}/images/paysuccess.png);
            ...
            <div class="paysuccess-title">
             ...
             <div class="paysuccess-foot">
                <div class="paysuccess-foot-center">
                    ...
                    <a href="${zl.web.dcms.domain}/index.action" class="btn btn-primary">
                        返回首页
                    </a>
                </div>
             </div>
...
<script type="text/javascript">  
    $(function() {  
        ...
        setInterval(function() {  
            count--;  
            if (count <= 0){
                 window.location.href = "${zl.web.dcms.domain}/index.action";
            }
            else{
