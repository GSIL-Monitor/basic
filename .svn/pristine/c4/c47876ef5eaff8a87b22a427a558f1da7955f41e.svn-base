...
<script>
    ...
    function addUser() {
        ...
        var url = '${ctxPath}/portal/user/add.action';
        var params = {
            username: username,
            password: password,
            fullname: fullname,
                            ...
                            <div class="form-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group">
                                            <input class="form-control" placeholder="选择门店" _column="branchname"
                                                   ...
                                                   readonly="readonly"
                                                   name="branchname"/>
                                            <input type="hidden" _column="id" id="branchcode" name="branchcode"/>
                                            <input type="hidden" _column="branchcode" id="branchcode" name="branchcode"/>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mt-radio-inline">
                                            <label class="mt-radio">
                                                <input type="radio" name="iscashier" value="0" checked> 否
                                                <span></span>
                                            </label>
                                            <label class="mt-radio">
                                                <input type="radio" name="iscashier" value="1"> 是
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mt-radio-inline">
                                            <label class="mt-radio">
                                                <input type="radio" name="isbuyprice" value="0"> 否
                                                <span></span>
                                            </label>
                                            <label class="mt-radio">
                                                <input type="radio" name="isbuyprice" value="1" checked> 是
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mt-radio-inline">
                                            <label class="mt-radio">
                                                <input type="radio" name="userflag" value="1" checked> 正常
                                                <span></span>
                                            </label>
                                            <label class="mt-radio">
                                        ...
                                        <div class="mt-checkbox-inline" id="userRoles">
                                            <#if roleList?? && roleList?size gt 0>
                                                <#list roleList as role>
                                                    <label class="mt-checkbox">
                                                        <input type="checkbox" name="userrole" code="${role.code!''}"
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="mt-checkbox-inline">
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="01"> 改价权限
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="02"> 单品折扣
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="03"> 整单折扣
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="04"> 交易查询
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="05"> 按单退货
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="06"> 商品退货(不按单)
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="07"> 补打小票
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="08"> 开钱箱
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="09"> 会员登记
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="10"> 收银对账
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="11"> 库存查询
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="12"> 系统设置
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="13"> 会员充值
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="14"> 赠送
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="15"> 会员积分增减
                                                <span></span>
                                            </label>
                                            <label class="mt-checkbox">
                                                <input type="checkbox" name="cashiergrant" value="16"> 跨店库存查询
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
                ...
                <div class="form-body">
                    <div class="form-group">
                        <div class="col-md-offset-3 col-md-9">
                            <button type="button" onclick="addUser()" class="btn btn-default "><i
                                    class="fa fa-save"></i> 保存
                            </button>
                            <button type="button" onclick="back()" class="btn btn-default "><i class="fa fa-reply"></i>
                                取消
                            </button>
                        </div>
                    </div>
...
<@override name="window">
    <#include "../choose/choose-modal.ftl"/>
</@override>
