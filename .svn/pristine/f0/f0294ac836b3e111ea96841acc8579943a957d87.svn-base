...
//    }
    ...
    @Override
    public ZLResult test(Map<String, Object> params){
        return ZLResult.Success();
    }

    @Override
    public void removeUserInfo(String accessCode) {
        RedisFactory.getDefaultClient().del(new StringBuilder(Contants.ACCESS_CODE_PREFIX).append(accessCode).toString());
    }
}