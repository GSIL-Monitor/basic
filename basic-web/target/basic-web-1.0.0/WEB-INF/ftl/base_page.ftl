            ...
            <div class="page-header">
                ...
                <div class="page-header-top">
                    <div class="container">
                        <!-- BEGIN LOGO -->
                        <div class="page-logo">
                            <a href="http://dev.cnzhonglunnet.com:8080/dcms-web/index.action">
                ...
                <script>
                    ...
                    if (user_headpic && user_headpic != '') {
                        ...
                        user_headpic = 'http://091801.zhonglunnet.com/web/images/headpic.png';
                    }
                    var user_namelabel = userNodes.fullname;
                    var headlihtml = '<ul class="dropdown-menu dropdown-menu-default"><li><a href="http://dev.cnzhonglunnet.com:8080/urms-web/portal/user/toSetHeadPic.action"><i class="icon-user"></i> 头像设置 </a></li><li><a href="http://dev.cnzhonglunnet.com:8080/urms-web/login/entry/logout.action?account=' + userNodes.account + '"><i class="icon-key"></i> 退出 </a></li></ul><a href="javascript:;"class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true"><img alt="" onerror="javascript:this.src=\'http://091801.zhonglunnet.com/web/images/no-img.jpg\';" class="img-circle" width="39" src="' + user_headpic + '"/><span class="username username-hide-on-mobile">' + user_namelabel + '</span></a>';
