...
<#-- 输出分页表单 -->
    ...
    <script>
        ...
        function jumpPage_${pageid!''}(pageid, no, url) {
            ...
            var zlPageContainer = showDataView.attr('zl-page-container') || '';
            if (zlPageContainer != '') {
                var params = showDataView.serialize();
                ajaxSyncInSameDomain(url, params, function (result) {
                    $(zlPageContainer).html(result);
                }, 'html');
            } else {
    ...
    <div class="dataTables_paginate paging_bootstrap_full_number">
        ...
        <#-- 把请求中的所有参数当作隐藏表单域(无法解决一个参数对应多个值的情况)-->
            ...
            <#if (page != 1)>
                <li><a href="javascript:void(0)" onclick="jumpPage_${pageid!''}('${pageid}',${start},'${toURL}')"><i
                        class="fa fa-angle-double-left"></i></a>
                </li>
                <li><a href="javascript:void(0)" onclick="jumpPage_${pageid!''}('${pageid}',${page - 1},'${toURL}')"><i
            ...
            <#list start..end as i>
                <li <#if i==page>class="active"</#if> >
                    <a href="javascript:void(0)" onclick="jumpPage_${pageid!''}('${pageid}',${i},'${toURL}')">${i}</a>
                </li>
            </#list>

            <#if (page != pageCount)>
                <li><a href="javascript:void(0)" onclick="jumpPage_${pageid!''}('${pageid}',${page + 1},'${toURL}')"
                       class="pager-nav"><i class="fa fa-angle-right"></i></a></li>
                <li><a href="javascript:void(0)" onclick="jumpPage_${pageid!''}('${pageid}',${pageCount},'${toURL}')"
