...
<script src="http://091801.zhonglunnet.com/web/js/qrcodejs-master/qrcode.js?version=1.0.0"></script>
</@override>
            ...
            if (orderstatus && orderstatus == '5') {
                ...
                AlertMsg('支付完成', function () {
                    if(businessorigin && businessorigin == 'srvms-serverRecharge'){
                        window.location.href = 'http://fwsdev.cnzhonglunnet.com'+url;
                    }else if(businessorigin && businessorigin == 'bugms-service'){
                        window.location.href = 'http://fwsdev.cnzhonglunnet.com'+url;
                    }else {
                        window.location.href = 'http://lsdev.cnzhonglunnet.com'+url;
                    }
                });
            }
        })
...
<style>
    ...
    .wxpaydesc {
        ...
        background: url(http://091801.zhonglunnet.com/web/images/icon-red.png) 30px 8px no-repeat #ff7674;
    }
        ...
        <div class="panel panel-default cashier-title">
            ...
            <div class="panel-body">
                ...
                <div class="qrcode_phone">
                    <img src="http://091801.zhonglunnet.com/web/images/phone-bg.png">
                </div>
            </div>
