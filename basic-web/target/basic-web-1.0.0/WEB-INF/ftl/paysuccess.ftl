...
<style type="text/css">
    ...
    .paysuccess-block-icon i{
        ...
        display: block;
        margin: auto;
        background-image: url(http://091801.zhonglunnet.com/web/images/paysuccess.png);
            ...
            <div class="paysuccess-title">
             ...
             <div class="paysuccess-foot">
                <div class="paysuccess-foot-center">
                    ...
                    <a href="http://dev.cnzhonglunnet.com:8080/dcms-web/index.action" class="btn btn-primary">
                        返回首页
                    </a>
                </div>
             </div>
...
<script type="text/javascript">  
    $(function() {  
        ...
        setInterval(function() {  
            count--;  
            if (count <= 0){
                 window.location.href = "http://dev.cnzhonglunnet.com:8080/dcms-web/index.action";
            }
            else{
