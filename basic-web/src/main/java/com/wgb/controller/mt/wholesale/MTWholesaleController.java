    ...
    public ZLResult exportWholesaleCount(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if ("1".equals(searchtype)) {
                if(StringUtils.equals(industryid,"12")){//服装行业
                    String[] purchase = {"commoditycode","barcode", "commodityname","specvalue", "categoryname", "spec", "unitname",
                    ...
                    String[] purchaseNames = {"货号","条形码", "商品名称","颜色/尺码", "商品类别", "规格", "单位",
                    ...
                    String[] purchase = {"spucode", "commodityname", "categoryname", "spec", "unitname",
                            "numbertotal", "amounttotal", "receiptnumstotal", "receiptamounttotal", "returnnumtotal",
                            "returnamounttotal", "giftnumbertotal", "giftamounttotal", "costamounttotal", "profit",
                            "profitrate", "suppliername"};
                ...
                if(StringUtils.equals(industryid,"12")){//服装行业
                    String[] purchase = {"billcode", "billtype", "customercode", "customername", "branchname","barcode",
                             "commodityname","specvalue", "categoryname", "spec", "unitname",
                            "quantity", "receiptprice", "wholesaleamount", "giftnumbertotal", "giftamounttotal",
                            "costamounttotal", "profit", "profitrate", "billremark", "remark"};
                    String[] purchaseNames = {"业务单号", "单据类型", "客户编号", "客户名称", "所属门店","条形码",
                            "商品名称","颜色/尺寸", "商品类别", "规格", "单位",
        ...
        try {
            ...
            if ("1".equals(searchtype)) {
                ...
                if(StringUtils.equals(industryid,"12")){
                    String[] purchase = {"customercode", "customername","spucode","barcode",
                            "commodityname", "specvalue", "unitname",
                            "numbertotal", "amounttotal", "receiptnumstotal", "receiptamounttotal", "returnnumtotal",
                            "returnamounttotal", "giftnumbertotal", "giftamounttotal", "costamounttotal", "profit",
                            "profitrate", "suppliername"};
                    String[] purchaseNames = {"客户编号", "客户名称",
                            "货号","条形码", "商品名称", "颜色/尺码", "单位",
                            "数量小计", "金额小计", "销售数量", "销售金额", "退货数量",
                            "退货金额", "赠送数量", "赠送金额", "成本", "毛利",
                            "毛利率", "供应商"};
